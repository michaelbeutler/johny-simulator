...
describe('Integer Division (IDIV) Program Tests', () => {
  ...
  test('should divide 15 by 3 = 5 remainder 0', async () => {
    ...
    const initialMemory = { 100: 15, 101: 3, 105: 1 }; // dividend=15, divisor=3, constant=1
  ...
  test('should divide 17 by 5 = 3 remainder 2', async () => {
    const parseResult = parser.parseFile('scripts/idiv.ram');
    const initialMemory = { 100: 17, 101: 5, 105: 1 }; // dividend=17, divisor=5, constant=1
    const finalState = simulator.simulate(parseResult.ram, 0, initialMemory);
  ...
  test('should divide 7 by 10 = 0 remainder 7', async () => {
    const parseResult = parser.parseFile('scripts/idiv.ram');
    const initialMemory = { 100: 7, 101: 10, 105: 1 }; // dividend=7, divisor=10, constant=1
    const finalState = simulator.simulate(parseResult.ram, 0, initialMemory);
  ...
  test('should divide 20 by 1 = 20 remainder 0', async () => {
    const parseResult = parser.parseFile('scripts/idiv.ram');
    const initialMemory = { 100: 20, 101: 1, 105: 1 }; // dividend=20, divisor=1, constant=1
    const finalState = simulator.simulate(parseResult.ram, 0, initialMemory);
  ...
  test('should divide 0 by 5 = 0 remainder 0', async () => {
    const parseResult = parser.parseFile('scripts/idiv.ram');
    const initialMemory = { 100: 0, 101: 5, 105: 1 }; // dividend=0, divisor=5, constant=1
    const finalState = simulator.simulate(parseResult.ram, 0, initialMemory);
  ...
  test('should handle division by 1', async () => {
    const parseResult = parser.parseFile('scripts/idiv.ram');
    const initialMemory = { 100: 7, 101: 1, 105: 1 }; // dividend=7, divisor=1, constant=1
    const finalState = simulator.simulate(parseResult.ram, 0, initialMemory);
  ...
  test('should handle perfect division', async () => {
    const parseResult = parser.parseFile('scripts/idiv.ram');
    const initialMemory = { 100: 12, 101: 4, 105: 1 }; // dividend=12, divisor=4, constant=1
    const finalState = simulator.simulate(parseResult.ram, 0, initialMemory);
  ...
  test('should handle large remainder', async () => {
    const parseResult = parser.parseFile('scripts/idiv.ram');
    const initialMemory = { 100: 23, 101: 7, 105: 1 }; // dividend=23, divisor=7, constant=1
    const finalState = simulator.simulate(parseResult.ram, 0, initialMemory);
  ...
  test('should handle same dividend and divisor', async () => {
    const parseResult = parser.parseFile('scripts/idiv.ram');
    const initialMemory = { 100: 5, 101: 5, 105: 1 }; // dividend=5, divisor=5, constant=1
    const finalState = simulator.simulate(parseResult.ram, 0, initialMemory);
  ...
  test('should handle single digit operations', async () => {
    const parseResult = parser.parseFile('scripts/idiv.ram');
    const initialMemory = { 100: 8, 101: 3, 105: 1 }; // dividend=8, divisor=3, constant=1
    const finalState = simulator.simulate(parseResult.ram, 0, initialMemory);
  ...
  test('should handle division by zero gracefully', async () => {
    const parseResult = parser.parseFile('scripts/idiv.ram');
    const initialMemory = { 100: 17, 101: 0, 105: 1 }; // dividend=17, divisor=0
    const finalState = simulator.simulate(parseResult.ram, 0, initialMemory);

    expect(finalState.halted).toBe(true);
    expect(finalState.ram[102]).toBe(0); // quotient = 0 (special case)
    expect(finalState.ram[103]).toBe(17); // remainder = original dividend
  });
});
