...
function RamDb() {
  ...
  highlightRamAccess();
  document.getElementById("DataBus").innerHTML = zeroPad(
    Datenbus,
    ramLength + 1
  );
  aufnehmen(2);
...
function DbAcc() {
  ...
  document.getElementById("Accumulator").innerHTML = zeroPad(
    Akkumulator,
    ramLength + 1
  );
...
function IncPc0() {
  if (
    Programmzaeler < parseInt("9".repeat(ramLength - 1)) &&
    Akkumulator == 0
  ) {
    writeToPc(Programmzaeler + 1);
  }
